var text = {
    ...
    PreCharterFundingDescription: 'If your student group is not yet chartered, or is currently going through the chartering process, you have the option of requesting seed funding from Student Orgs. For more information and details on pre-chartering funding, please see Step 3 of Chartering Process or send Student Orgs an email at the link below. There, you will also find information on the chartering process.',
    ...
    CharteringSteps: {
        ...
        StepThree: 'During this two month period, if your group is in need of immediate funding, you may request an allocation from the SOC. These funds are intended to prove to the SOC that your group is capable of using funding from the Student Activities Budget effectively. Please complete the form here and email Student Orgs. ',
