var text = {
    ...
    FundingDescription: 'Only chartered student organizations are eligible for funding from the Student Activities Budget via SBC. A majority of the yearly budget for student organizations is allocated during Spring Budgeting the year before. Supplementary funding is also available throughout the year on a proposal basis. Please refer to the Budgeting Guide for more information on Spring Budgeting and proposing for supplementary funding.',
